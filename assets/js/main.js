...
window.addEventListener("scroll",()=>{
    ...
    const topBg = getComputedStyle(document.documentElement).getPropertyValue("--header-bg").trim();
    const scrolledBg = getComputedStyle(document.documentElement).getPropertyValue("--header-bg-scroll").trim();
